<template>
  <el-submenu v-if="menu.children && menu.children.length >= 1" :index="'' + menu.Id" background-color="#243344">
    <template slot="title">
  ...
  <el-menu-item v-else :index="'' + menu.Id" @click="handleRoute(menu)"  class="under-menu">
    <!--  -->
    <!-- <i :class="menu.IconUrl"></i> -->
